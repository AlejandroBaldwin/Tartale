    ...
    <section className={`dessert-description ${modalState}`} onClick={clickBackdrop}>
        <section className='dessert-description__container'>
            <section className='dessert-description__container__contents'>
                ...
                <p className='dessert-description__container__description'>Veniam ipsum enim aute et voluptate ad nulla consequat anim. Incididunt pariatur mollit amet consequat tempor elit occaecat eu. Magna deserunt aliqua laborum enim duis dolore aliquip dolore quis minim. Ad adipisicing ad et commodo ullamco ex veniam consequat minim esse et excepteur. Deserunt amet esse duis veniam.</p>
